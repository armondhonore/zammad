...
**Live:** [https://relaxed-weasel-zammad.cloud.nexlayer.ai](https://relaxed-weasel-zammad.cloud.nexlayer.ai)  
...
**zammad** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  - name: app
    ...
    vars:
      ...
      DATABASE_URL: "postgresql://zammad:${POSTGRES_PASSWORD}@postgres.pod:5432/zammad"
      ELASTICSEARCH_HOST: "localhost"
      ZAMMAD_RAILSSERVER_HOST: "0.0.0.0"
      ZAMMAD_WEBSOCKET_HOST: "0.0.0.0"
  - name: postgres
